class ValidatorLogic {
  String? requiredField(String? text, {String fieldName = 'This field'}) {
  ...
  String? requiredNumber(String? text, {String fieldName = 'This field'}) {
    if (text != null && text.isNotEmpty) {
  ...
  String? requiredPassword(String? text) {
    if (text != null && text.isNotEmpty) {
  ...
  String? requiredInteger(String? text, {String fieldName = 'This field'}) {
    if (text != null && text.isNotEmpty) {
